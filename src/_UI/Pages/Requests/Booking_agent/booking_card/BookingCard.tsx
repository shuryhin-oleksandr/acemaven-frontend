      ...
      {isFetching || !exact_booking_info ? (
        ...
        <CardWrapper>
          <CardContent>
            ...
            <GeneralBookingInfo>
              ...
              <GeneralBookingContent>
                <GeneralShipType margin_top={"3px"}>
                  <img
                    src={
                      exact_booking_info?.shipping_type === "sea"
                        ? sea_icon
                        : air_icon
                    }
                    alt=""
                ...
                <InfoRow margin_right="28px">
                  ...
                  >
                    ...
                    <RouteName>
                      {exact_booking_info?.freight_rate.destination.code}
                    </RouteName>
                  </InfoRowValue>
                </InfoRow>
                <ValuesShipmentWrapper>
            ...
            <ShipmentInfoBlock
              shipper={
                exact_booking_info?.shipper ? exact_booking_info?.shipper : null
              }
            ...
            <HiddenInfoPart
              cargo_groups={
                exact_booking_info?.cargo_groups
                  ? exact_booking_info.cargo_groups
                  : []
              }
              number_of_documents={Number(
                exact_booking_info?.number_of_documents
              )}
              release_type={exact_booking_info?.release_type}
              charges_cost={
                exact_booking_info?.charges ? exact_booking_info?.charges : null
              }
