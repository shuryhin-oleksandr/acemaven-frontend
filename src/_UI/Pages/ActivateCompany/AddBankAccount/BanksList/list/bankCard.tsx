...
import {CardContent, CardWrap, Data, DefaultIcon, DefaultText, DefaultWrap, Label, LineWrap, SetDefaultButton, Wrapper} from "../bank-list-styles";
...
const BankCard:React.FC<PropsType> = ({max_width, w, b, deleteBank, defaultBank, flex_direction}) => {
