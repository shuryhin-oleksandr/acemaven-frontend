...
const LatestQuotesWidget: React.FC = () => {
    ...
    let latest_list = []
    const last = company_type?.type === AppCompaniesTypes.AGENT
        ? agent_quotes_list[agent_quotes_list.length - 1]
        : my_quotes_list[my_quotes_list.length - 1]
    latest_list.push(last)
    const penult = company_type?.type === AppCompaniesTypes.AGENT
        ? agent_quotes_list[agent_quotes_list.length - 2]
        : my_quotes_list[my_quotes_list.length - 2]
    latest_list.push(penult)
