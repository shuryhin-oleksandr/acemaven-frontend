...
const OptionsDeliveryButtons:React.FC<PropsType> = ({setMode, mode, ...props}) => {

    let dispatchDeliveryHandler = (type: string) => {
        setMode && setMode(type)
        props.dispatch && props.dispatch(filterByThunk(props.directory, type, '', props.searchColumn,props.searchValue))
    }
    ...
    return (
        <OptionsButtonsWrap>
            ...
            <OptionButtonPlane onClick={() => dispatchDeliveryHandler('air')} mode={mode}>
