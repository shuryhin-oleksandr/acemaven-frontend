...
export const conditions =  [{id: 1, title: 'w/m', tooltip: 'This option will indicate that the charge will be calculated by the chargeable weight of the cargo.', displayName:"W/M"},
    {id: 2, title: 'per_weight', tooltip: 'Will be calculated by the weight of the cargo.', displayName: "Per weight"},
    {id: 3, title: 'per_no_of_packs', tooltip: 'As opposed to the previous option, it will consider the charge by the number of packs in the shipment/client’s search.', displayName: "Per no. of packs"},
