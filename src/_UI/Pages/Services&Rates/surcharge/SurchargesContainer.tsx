...
import OptionsDirectoryButtons from "../../../components/_commonComponents/optionsButtons/directory/OptionsDirectoryButtons";
...
const SurchargesContainer: React.FC = () => {
  ...
  let surcharges_list = useSelector(
    (state: AppStateType) => state.surcharge.surcharges_list
  );
