...
//styles
import {SupportInner, SupportOuter, SupportTitle} from "../help-support-styles";
import {FormFieldsWrap, TopicContent, TopicFormActionsWrap, TopicFormHeader} from './topic-form-styles';
import {FormTextarea, TextareaLabel} from "../../../components/PopUps/accept_booking_popup/accept-popup-styles";
                ...
                <SupportInner>
                    <TopicFormHeader>
                        ...
                        <TopicFormActionsWrap>
                            <BaseButton style={{marginRight: '10px'}} type='submit'>POST</BaseButton>
                    ...
                    <TopicContent>
                        <FormFieldsWrap>
                            <Controller name={'category'}
                                        ...
                                        as={
                                            <SurchargeRateSelect label={'Category'}
                                                                 placeholder={'General'}
                                                                 max_width={'170px'}
                            ...
                            />
                            <Controller name={'operation_number'}
                                        control={control}
                                        rules={{required: 'Field is required'}}
                                        as={
                                            <SurchargeRateSelect label={'Operation No.'}
                                                                 placeholder={'Ofh4848'}
                                                                 max_width={'195px'}
                        ...
                        <Controller name='description'
                                    ...
                                    as={
                                        <div style={{width: '100%', marginBottom: '50px'}}>
                                            ...
                                            <FormTextarea error={!!errors?.description}
                                                          placeholder='Describe your problem...'
                                            />
                                            {errors?.description && <HelperText messagePaddingTop='4px'>Field is required</HelperText>}
                                        </div>
                                    }
                        />
                    </TopicContent>
