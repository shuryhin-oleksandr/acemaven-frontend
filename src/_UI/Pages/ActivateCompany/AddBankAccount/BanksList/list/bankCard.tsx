...
const BankCard:React.FC<PropsType> = ({max_width, w, b}) => {

    const dispatch = useDispatch()

    const defaultBankHandler = (id: number) => {
        dispatch(makeDefaultBank(id, {is_default: true}))
    }
    const deleteBankHandler = (id: number) => {
    ...
    return (
        <CardWrap max_width={max_width}>
            <CardContent>
                <DeleteButton onClick={() => deleteBankHandler(b?.id as number)}><img src={deleteIcon} alt=""/></DeleteButton>
                <Wrapper>
                    <LineWrap w={w}>
                ...
                <DefaultWrap>
                    ...
                    {b?.is_default
                        ...
                        : <SetDefaultButton onClick={() => defaultBankHandler(b?.id as number)}>Set as default</SetDefaultButton>
                    }
                </DefaultWrap>
            </CardContent>
        </CardWrap>
